...
class ConexionDatos {
    ...
    private static final String URL = "jdbc:mysql://localhost:3306/DI?useSSL=false&allowPublicKeyRetrieval=true&characterEncoding=utf8&serverTimezone=Europe/Madrid";
